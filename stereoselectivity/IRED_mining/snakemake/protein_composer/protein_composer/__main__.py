"""
Entrypoint for protein_composer
...
def get_version():
    ...
    with open(snake_base("protein_composer.VERSION"), "r") as f:
        version = f.readline()
    return version
...
def print_citation():
    ...
    with open(snake_base("protein_composer.CITATION"), "r") as f:
        for line in f:
            echo_click(line)
...
\b
CLUSTER EXECUTION:
protein_composer run ... --profile [profile]
For information on Snakemake profiles see:
https://snakemake.readthedocs.io/en/stable/executing/cli.html#profiles
\b
RUN EXAMPLES:
Required:           protein_composer run --input [file]
Specify threads:    protein_composer run ... --threads [threads]
Disable conda:      protein_composer run ... --no-use-conda 
Change defaults:    protein_composer run ... --snake-default="-k --nolock"
Add Snakemake args: protein_composer run ... --dry-run --keep-going --touch
Specify targets:    protein_composer run ... all print_targets
Available targets:
